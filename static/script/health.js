...
fetch(`https://newsapi.org/v2/top-headlines?country=in&apiKey=c72a987d126642c1a596de5b9d40ee61&category=health&pageSize=10&page=1`,{
    method:"GET"
...
window.addEventListener("scroll",()=>{
    if(document.documentElement.scrollTop+window.innerHeight+1 >= document.documentElement.scrollHeight ){
        if(index<totalResults){
            ...
            let lodding = document.createElement("img")
            lodding.setAttribute("src","./static/images/Ripple-1.9s-198px.svg")
            fetch(`https://newsapi.org/v2/top-headlines?country=in&apiKey=c72a987d126642c1a596de5b9d40ee61&category=health&pageSize=10&page=${page}`,{
                method:"GET"
            }).then((res)=>res.json()).then((ele)=>{
                suraj.style.display="none"
                page= page+1
